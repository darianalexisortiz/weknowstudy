...
namespace Drupal\weknow_services\Event;

/**
 * Defines events for the weknow_services module.
 *
 ...
 * 'weknow_services.new_incident_report'. This event will be dispatched by the
 * form controller \Drupal\weknow_services\Form\EventsExampleForm whenever a new
...
final class IncidentEvents {
   ...
   * \Drupal\weknow_services\Event\IncidentReportEvent instance.
   *
   * @Event
   *
   * @see \Drupal\weknow_services\Event\IncidentReportEvent
   *
   * @var string
   */
  const NEW_REPORT = 'weknow_services.new_incident_report';
