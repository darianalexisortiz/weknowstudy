...
const PROXY = 'https://weknow-study.lndo.site';
const PUBLIC_PATH = '/modules/custom/react_block/js/dist_dev/';
...
const config = {
  ...
  output: {
    path: isDevMode ? path.resolve(__dirname, "js/dist_dev") : path.resolve(__dirname, "js"),
